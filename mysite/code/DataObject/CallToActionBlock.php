...
class CallToActionBlock extends DataObject {
  ...
  private static $db = array(	
    ...
    'ImagePosition' => "Enum(array('Above Title','Below Title'))",
  );
 ...
 // tidy up the CMS by not showing these fields
  public function getCMSFields() {
    ...
    $ImageAlign = new DropdownField('ImagePosition','Image Align',singleton('CallToActionBlock')->dbObject('ImagePosition')->enumValues());
