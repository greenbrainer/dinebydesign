...
tabs.prototype = {
   ...
   _setVars: function() { var $this = this;
      ...
      this._contentParent = this._content.parent('.tabsContent');
      if(!this._contentParent) return false;
   ...
   _initHeight: function() { var $this = this;
   ...
   _tabToggle: function(obj) { var $this = this;
      ...
      this._content.each(function() {
         if($(this).attr('data-tab-id') == tabId) {
            ...
            $this._contentParent.height($(this).height());
         }
      });
